	...
	return (
		<div className="w-[229px] flex flex-col gap-4 shrink-0">
			<Image
				...
				height={100}
				src={
					"https://res.cloudinary.com/urbanclap/image/upload/t_high_res_template/w_229,dpr_2,fl_progressive:steep,q_auto:low,f_auto,c_limit/images/growth/home-screen/1685703008534-c8d700.jpeg"
				}
			/>
			<div>
	...
	return (
		<div className="flex justify-center px-8 pb-12">
			<div className="w-full max-w-screen-xl flex flex-col gap-6">
				...
				<div className="flex flex-wrap gap-8 overflow-x-scroll remove-scroll">
					<Card />
					<Card />
					<Card />
					<Card />
